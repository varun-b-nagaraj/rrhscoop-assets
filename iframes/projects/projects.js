...
const statusDropdown = window.createProjectDropdown(statusFilterElement, value => { state.status = value; render(); });
const sortDropdown = window.createProjectDropdown(sortElement, value => { state.sort = value; render(); });
