...
(function () {
  ...
  const visuals = new URL('custom-visuals/rrhscoop-visuals.js?v=27', base).href;
  ...
  const projectDeepLinks = new URL('custom-visuals/rrhs-project-deeplinks.js?v=3', base).href;
