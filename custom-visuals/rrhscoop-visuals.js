...
(function () {
  ...
  const CATEGORY_CARD_MAP = {
    "ins-tile__category-item-169641499": {
      ...
      background: "#6e1f2a",
      foreground: "#faf8f4",
      wash: "rgb(110 31 42 / 0.8)",
      hoverWash: "rgb(110 31 42 / 0.24)",
      labelBackground: "rgb(77 17 28 / 0.88)",
      hoverLabelBackground: "rgb(77 17 28 / 0.76)",
      photoOpacity: "0",
    ...
    "ins-tile__category-item-169641959": {
      ...
      background: "#25364a",
      foreground: "#faf8f4",
      wash: "rgb(37 54 74 / 0.8)",
      hoverWash: "rgb(37 54 74 / 0.24)",
      labelBackground: "rgb(27 42 59 / 0.88)",
      hoverLabelBackground: "rgb(27 42 59 / 0.76)",
      photoOpacity: "0",
      visualFilter: "brightness(0) invert(1)"
    },
    "ins-tile__category-item-189782257": {
      ...
      background: "#d8c99b",
      foreground: "#241a17",
      wash: "rgb(216 201 155 / 0.82)",
      hoverWash: "rgb(216 201 155 / 0.3)",
      labelBackground: "rgb(203 185 134 / 0.9)",
      hoverLabelBackground: "rgb(203 185 134 / 0.8)",
      photoOpacity: "0",
      visualFilter: "brightness(0) saturate(100%) invert(10%) sepia(9%) saturate(652%) hue-rotate(326deg) brightness(92%) contrast(91%)"
    },
    "ins-tile__category-item-194772751": {
      ...
      background: "#4d111c",
      foreground: "#faf8f4",
      wash: "rgb(77 17 28 / 0.82)",
      hoverWash: "rgb(77 17 28 / 0.24)",
      labelBackground: "rgb(58 10 19 / 0.9)",
      hoverLabelBackground: "rgb(58 10 19 / 0.78)",
      photoOpacity: "0",
      visualFilter: "brightness(0) invert(1)"
    },
  ...
  function updateLeadershipFrameVersion() {
    ...
    try {
      ...
      if (url.searchParams.get("v") === "25") return;
      url.searchParams.set("v", "25");
      frame.src = url.href;
    } catch (_) {}
  }
